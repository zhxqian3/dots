...
if $muted; then
  pamixer -u
  dunstify -a "VOLUME" "UNMUTED" -I ~/.config/dunst/assets/ui/volume_up.png -h string:x-dunst-stack-tag:volume -u normal
else 
  pamixer -m
  dunstify -a "VOLUME" "MUTED" -h string:x-dunst-stack-tag:volume -u normal
fi
}
